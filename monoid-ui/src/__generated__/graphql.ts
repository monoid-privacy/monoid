...
export type UpdateRequestStatusInput = {
  requestStatusId: Scalars['ID'];
  resultData?: InputMaybe<Scalars['Upload']>;
  status: UpdateRequestStatusType;
};

export enum UpdateRequestStatusType {
  Executed = 'EXECUTED',
  Failed = 'FAILED'
}
...
export type SiloDataSourcesQuery = { __typename?: 'Query', siloDefinition: { __typename?: 'SiloDefinition', id: string, siloSpecification?: { __typename?: 'SiloSpecification', id: string, manual: boolean } | null, dataSources?: Array<{ __typename?: 'DataSource', id: string, name: string, group?: string | null, properties?: Array<{ __typename?: 'Property', id: string, name: string, categories?: Array<{ __typename?: 'Category', id: string, name: string }> | null, userPrimaryKey?: { __typename?: 'UserPrimaryKey', id: string, name: string } | null }> | null }> | null } };
...
export type UpdateRequestStatusMutation = { __typename?: 'Mutation', updateRequestStatus: { __typename?: 'RequestStatus', id: string, status: RequestStatusType, queryResult?: { __typename?: 'QueryResult', id: string, records?: string | null, resultType: ResultType } | null } };
...
export type GetSiloSpecQuery = { __typename?: 'Query', siloSpecification: { __typename?: 'SiloSpecification', id: string, schema?: string | null, manual: boolean } };
...
export type GetSiloTitleQuery = { __typename?: 'Query', siloDefinition: { __typename?: 'SiloDefinition', id: string, name: string, siloSpecification?: { __typename?: 'SiloSpecification', id: string, name: string, logo?: string | null, manual: boolean } | null } };
...
export type DeletePropertyMutation = { __typename?: 'Mutation', deleteProperty?: string | null };
...
export type CreateDataSourceMutation = { __typename?: 'Mutation', createDataSource: { __typename?: 'DataSource', id: string, name: string, group?: string | null, properties?: Array<{ __typename?: 'Property', id: string, name: string, categories?: Array<{ __typename?: 'Category', id: string, name: string }> | null }> | null } };
...
export const UpdateRequestStatusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateRequestStatus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateRequestStatusInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateRequestStatus"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"queryResult"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"records"}},{"kind":"Field","name":{"kind":"Name","value":"resultType"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateRequestStatusMutation, UpdateRequestStatusMutationVariables>;
